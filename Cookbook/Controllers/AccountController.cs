...
namespace Cookbook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "You didn't verified your email address.");
                        return View(model);
                    }
                }
                else
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                    {UserName = model.Email, Email = model.Email, Language = "ru", Theme = "green"};
                ...
                if (result.Succeeded)
                {
                    ...
                    return View("EmailConfirmationLink");
                }
        ...
        {
            if (userId == null || code == null) return RedirectToAction(nameof(RecipeController.Index), "Recipe");
